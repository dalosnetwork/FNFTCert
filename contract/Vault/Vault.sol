...
contract Vault {
    ...
    function redeemAll(uint256 _tokenID, address _owner) public onlyClean() returns(bool) {
        ...
        delete NFTreferToken[_tokenID]; // Delete NFT reference
        delete TokenreferNFT[_erc20Address]; // Delete token reference
    ...
    function addToCleanList(address _cleanAddress) public onlyClean() {
